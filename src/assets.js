...
{id:1,name:'Security Personnel',stat:'F,1',hp:3,cost:2,type:'Military Unit',saves:'Di,1,Up,1',atk:'F,F,1d3+1',counter:'1d4',extras:``,text:``},
{id:2,name:'Hitmen',stat:'F,1',hp:1,cost:2,type:'Special Forces',saves:'Co,1',atk:'F,C,1d6',counter:'',extras:``,text:``},
{id:3,name:'Militia',stat:'F,1',hp:4,cost:4,type:'Military Unit',saves:'Up,2,Di,1',atk:'F,F,1d6',counter:'1d4+1',extras:``,text:``},
...
{id:5,name:'Elite Skirmishers',stat:'F,2',hp:5,cost:5,type:'Military Unit',saves:'Up,2',atk:'F,F,2d4',counter:'1d4+1',extras:``,text:``},
{id:6,name:'Hardened Personnel',stat:'F,2',hp:4,cost:4,type:'Special Forces',saves:'Di,1,Up,1',atk:'',counter:'1d4+1',extras:``,text:``},
{id:7,name:'Guerilla Populace',stat:'F,2',hp:6,cost:4,type:'Military Unit',saves:'Di,1,Up,1',atk:'F,C,1d4+1',counter:'',extras:``,text:``},
{id:8,name:'Zealots',stat:'F,3',hp:4,cost:6,type:'Special Forces',saves:'Up,2',atk:'F,F,2d6',counter:'2d6',extras:`Zealots take 1d4 damage every time they launch a successful attack or perform a counterattack.`,text:``},
{id:9,name:'Cunning Trap',stat:'F,3',hp:2,cost:5,type:'Tactic',saves:'',atk:'',counter:'1d6+3',extras:``,text:``},
{id:10,name:'Counterintel Unit',stat:'F,3',hp:4,cost:6,type:'Special Forces',saves:'Co,3,Di,1',atk:'C,C,1d4+1',counter:'1d6',extras:``,text:``},
...
{id:13,name:'Strike Fleet',stat:'F,4',hp:8,cost:12,type:'Starship',saves:'Up,3',atk:'F,F,2d6',counter:'1d8',extras:`As an action, they can move to an adjacent sector.`,text:`Frigate or cruiser-class vessels, space-to-ground weaponry and sophisticated, and light planetary defense weaponry. `},
{id:14,name:'Postech Infantry',stat:'F,4',hp:12,cost:8,type:'Military Unit',saves:'Up,3,Di,2',atk:'F,F,1d8',counter:'1d8',extras:``,text:``},
{id:15,name:'Blockade Fleet',stat:'F,5',hp:8,cost:10,type:'Starship',saves:'Di,3',atk:'F,W,1d6',counter:'',extras:`On a successful hit, they steal 1d4 FacCreds from the target faction as well. This theft can occur to a faction only once per turn, no matter how many blockade fleets attack. As an action, this asset may also move itself to an adjacent sector.`,text:``},
{id:16,name:'Psychic Assassins',stat:'F,5',hp:4,cost:12,type:'Special Forces',saves:'Up,2,Co,4',atk:'C,C,2d6+2',counter:'',extras:`These assets start Stealthed when purchased.`,text:``},
{id:17,name:'Pretech Infantry',stat:'F,6',hp:16,cost:20,type:'Military Unit',saves:'Up,3',atk:'F,F,2d8',counter:'2d8+2',extras:``,text:``},
...
{id:19,name:'Gravtank Formation',stat:'F,6',hp:14,cost:25,type:'Military Unit',saves:'Up,4',atk:'F,F,2d10+4',counter:'1d10',extras:``,text:``},
...
{id:21,name:'Integral Protocols',stat:'F,7',hp:10,cost:20,type:'Facility',saves:'Co,5',atk:'',counter:'2d8+2',extras:`They can defend only against attacks versus Cunning, but they add an additional die to the defender’s roll.`,text:``},
{id:22,name:'Space Marines',stat:'F,7',hp:16,cost:30,type:'Military Unit',saves:'Up,5,Di,3',atk:'F,F,2d8+2',counter:'2d8',extras:`As an action, they may move to an adjacent sector.`,text:``},
{id:23,name:'Capital Fleet',stat:'F,8',hp:30,cost:40,type:'Starship',saves:'Up,5',atk:'F,F,3d10+4',counter:'3d8',extras:`Upkeep, Capital fleets cost an additional 2 Creds of maintenance each turn. As an action, they may move to an adjacent sector. `,text:``},
{id:24,name:'Smugglers',stat:'C,1',hp:4,cost:2,type:'Starship',saves:'Co,1',atk:'C,W,1d4',counter:'',extras:`For one Cred, the smugglers can move itself or any one Special Forces unit up to two sectors away.`,text:``},
{id:25,name:'Informers',stat:'C,1',hp:3,cost:2,type:'Special Forces',saves:'Co,2',atk:'',counter:'',extras:`They can choose to Attack any faction, and need not specify a particular asset to target. On a successful Cunning vs. Cunning attack, all Stealthed assets on the planet belonging to that faction are revealed. Informers can target a faction even if none of their assets are visible on a world.`,text:``},
...
{id:27,name:'Lobbyists',stat:'C,2',hp:4,cost:4,type:'Special Forces',saves:'De,1,Ig,2',atk:'',counter:'',extras:`When a rival faction gains permission to build an asset, the Lobbyists can make an immediate Cunning vs. Cunning test against the faction; if successful, the permission is withdrawn and cannot be attempted again until the next turn.`,text:``},
{id:28,name:'Saboteurs',stat:'C,2',hp:6,cost:5,type:'Special Forces',saves:'Co,2,Up,1',atk:'C,C,2d4',counter:'',extras:`An asset attacked by saboteurs cannot use any Action ability until the start of the attacking faction’s next turn. This lock applies whether or not the saboteurs’ attack was successful.`,text:``},
{id:29,name:'Blackmail',stat:'C,2',hp:4,cost:4,type:'Tactic',saves:'Up,1',atk:'C,C,1d4+1',counter:'',extras:`Any attempt to attack or defend against Blackmail loses any bonus dice earned by tags.`,text:``},
{id:30,name:'Seductress',stat:'C,2',hp:4,cost:4,type:'Special Forces',saves:'Co,2',atk:'',counter:'',extras:`As an action, a Seductress can travel to any adjoining sector. As an attack, a Seductress does no damage, but an asset that has been successfully attacked immediately reveals any other Stealthed assets on the planet. Only Special Forces units can attack a Seductress.`,text:``},
{id:31,name:'Cyberninjas',stat:'C,3',hp:4,cost:6,type:'Special Forces',saves:'Up,2,Co,2',atk:'C,C,2d6',counter:'',extras:``,text:``},
...
{id:34,name:'Party Machine',stat:'C,4',hp:10,cost:10,type:'Facility',saves:'Po,2,Co,2',atk:'C,C,2d6',counter:'1d6',extras:`Each turn, a Party Machine provides 1 Cred to its owning faction.`,text:``},
{id:35,name:'Vanguard Cadres',stat:'C,4',hp:12,cost:8,type:'Military Unit',saves:'Up,2,Co,3',atk:'C,C,1d6',counter:'1d6',extras:``,text:``},
{id:36,name:'Tripwire Cells',stat:'C,4',hp:8,cost:12,type:'Special Forces',saves:'Co,3',atk:'',counter:'1d4',extras:`Whenever a stealthed asset enters the sector or is purchased in a sector with tripwire cells, the Cells make an immediate Cunning vs. Cunning attack against the owning faction. If successful, the asset loses its stealth.`,text:``},
{id:37,name:'Seditionists',stat:'C,4',hp:8,cost:12,type:'Special Forces',saves:'Co,3',atk:'',counter:'',extras:`For a cost of 1d4 Cred, the Seditionists can attach themselves to an enemy asset. Until they attach to a different asset or no longer share the same sector, the affected asset cannot perform an attack action.`,text:``},
{id:38,name:'Organization Moles',stat:'C,5',hp:8,cost:10,type:'Tactic',saves:'Co,4',atk:'C,C,2d6',counter:'',extras:``,text:``},
...
{id:41,name:'Transport Lockdown',stat:'C,6',hp:10,cost:20,type:'Tactic',saves:'Di,4',atk:'',counter:'',extras:`On a successful Cunning vs. Cunning attack against a rival faction, the rival faction cannot transport assets into that sector without spending 1d4 Cred and waiting one turn.`,text:``},
...
{id:43,name:'Demagogue',stat:'C,6',hp:10,cost:20,type:'Special Forces',saves:'Di,4,De,3,Co,2',atk:'C,C,2d8',counter:'1d8',extras:``,text:``},
{id:44,name:'Popular Movement',stat:'C,7',hp:16,cost:25,type:'Tactic',saves:'Ig,4,De,5',atk:'C,C,2d6',counter:'1d6',extras:``,text:``},
{id:45,name:'Book of Secrets',stat:'C,7',hp:10,cost:20,type:'Tactic',saves:'Ig,4,Co,5,Di,3',atk:'',counter:'2d8',extras:`Once per turn, a Book of Secrets allows the faction to reroll one die for an action taken in that sector or force an enemy faction to reroll one die. This reroll can only be forced once per turn, no matter how many Books of Secrets are owned.`,text:``},
...
{id:47,name:'Panopticon Matrix',stat:'C,8',hp:20,cost:30,type:'Facility',saves:'Co,5,Di,3',atk:'',counter:'1d6',extras:`Every rival Stealthed asset in the sector must succeed in a Cunning vs. Cunning test at the beginning of every turn or lose their Stealth. The owner also gains an additional die on all Cunning attacks and defenses in that sector.`,text:``},
{id:48,name:'Franchise',stat:'W,1',hp:3,cost:2,type:'Facility',saves:'Po,1',atk:'W,W,1d4',counter:'1d4-1',extras:`On a successful attack, the enemy faction loses one Cred (if available), which is gained by the Franchise’s owner. This loss can happen only once a turn, no matter how many Franchises attack.`,text:``},
{id:49,name:'Harvesters',stat:'W,1',hp:4,cost:2,type:'Facility',saves:'Po,2',atk:'',counter:'1d4',extras:`As an action, the Harvesters’ owning faction may roll 1d6. On 4+, one Cred is gained.`,text:``},
{id:50,name:'Local Investments',stat:'W,1',hp:2,cost:1,type:'Facility',saves:'Po,2',atk:'W,W,1d4-1',counter:'',extras:`Any other faction that tries to buy an asset in that sector must pay one extra Cred. This money is not given to the investments’ owner, but is lost. This penalty is only applied once, no matter how many Local Investments are present`,text:``},
{id:51,name:'Freighter Contract',stat:'W,2',hp:4,cost:5,type:'Starship',saves:'Po,2',atk:'W,W,1d4',counter:'',extras:`As an action, the faction may move any one non-Force asset, including this one, up to two sectors away at a cost of one Cred.`,text:``},
{id:52,name:'Lawyers',stat:'W,2',hp:4,cost:6,type:'Special Forces',saves:'Ig,1,Co,1',atk:'C,W,2d4',counter:'1d6',extras:`Lawyers cannot attack or counterattack Force assets.`,text:``},
{id:53,name:'Union Toughs',stat:'W,2',hp:6,cost:4,type:'Military Unit',saves:'Di,2',atk:'W,F,1d4+1',counter:'1d4',extras:``,text:``},
{id:54,name:'Surveyors',stat:'W,2',hp:4,cost:4,type:'Special Forces',saves:'Ig,1 ',atk:'',counter:'1d4',extras:`The presence of a Surveyor crew allows one additional die to be rolled on Expand Influence actions. As an action, a surveyor crew can move up to two sectors away.`,text:``},
{id:55,name:'Postech Industry',stat:'W,3',hp:4,cost:8,type:'Facility',saves:'Po,2,Ig,1',atk:'',counter:'1d4',extras:`As an action, roll 1d6. On a 1, one Cred is lost, on a 2, no profit is gained, on a 3-5 one Cred is earned, and a 6 returns two Creds. If money is lost and no resources are available to pay it, the Postech Industry is destroyed.`,text:``},
{id:56,name:'University',stat:'W,3',hp:4,cost:6,type:'Facility',saves:'Po,1,Ig,2',atk:'',counter:'',extras:``,text:``},
{id:57,name:'Mercenaries',stat:'W,3',hp:6,cost:8,type:'Military Unit',saves:'Di,1,Up,2',atk:'W,F,2d4+2',counter:'1d6',extras:`Mercenaries have a maintenance cost of one Cred per turn. As an action, Mercenaries can move to an adjacent sector. `,text:``},
...
{id:59,name:'Monopoly',stat:'W,4',hp:12,cost:8,type:'Facility',saves:'Po,3',atk:'W,W,1d6',counter:'1d6',extras:`As an action, owners of a monopoly may force one other faction with unstealthed assets in that sector to pay them one Cred. If the target faction hasn’t got the money, they lose one asset of their choice on the world.`,text:``},
{id:60,name:'Medical Center',stat:'W,4',hp:8,cost:12,type:'Facility',saves:'Po,3',atk:'',counter:'',extras:`Once between turns, if a Special Forces or Military Unit asset in the sector is destroyed, the faction may immediately pay half its purchase cost to restore it with one hit point. Any Repair Asset action taken on that world costs one less Cred for Special Forces and Military Units.`,text:``},
{id:61,name:'Bank',stat:'W,4',hp:8,cost:12,type:'Facility',saves:'Po,3',atk:'',counter:'',extras:`Once per turn, the faction can ignore one cost or FacCred loss imposed by another faction, regardless of where it is levied. Multiple banks allow multiple losses to be ignored.`,text:``},
{id:62,name:'Marketers',stat:'W,5',hp:8,cost:10,type:'Tactic',saves:'Po,3,Ig,1',atk:'C,W,1d6',counter:'',extras:`As an action, the marketers may test Cunning vs. Wealth against a rival faction’s asset. If successful, the target faction must immediately pay half the asset’s purchase cost, rounded down, or have it become disabled and useless until they do pay.`,text:``},
...
{id:64,name:'Venture Capital',stat:'W,6',hp:10,cost:15,type:'Facility',saves:'Po,4',atk:'W,W,2d6',counter:'1d6',extras:`As an action, roll 1d8; on a 1, the asset is destroyed, while on a 2-4 one Cred is gained, 5-7 yields two Cred and 8 grants three Cred.`,text:``},
{id:65,name:'R&D Department',stat:'W,6',hp:15,cost:18,type:'Facility',saves:'Po,4',atk:'',counter:'',extras:`A faction with an R&D department may treat all planets as having tech level 4 for purposes of buying Wealth assets.`,text:``},
{id:66,name:'Commodities Broker',stat:'W,6',hp:10,cost:20,type:'Special Forces',saves:'Po,4',atk:'W,W,2d8',counter:'1d8',extras:`As an action, roll 1d8; that many Cred are subtracted from the cost of their next asset purchase, down to a minimum of half normal price, rounded down.`,text:``},
{id:67,name:'Pretech Manufactory',stat:'W,7',hp:16,cost:25,type:'Facility',saves:'Po,5',atk:'',counter:'',extras:`As an action, roll 1d8 and gain half that many Cred, rounded up.`,text:``},
...
{id:70,name:'Scavenger Fleet',stat:'W,8',hp:20,cost:30,type:'Starship',saves:'Up,3,Di,2',atk:'W,W,2d10+4',counter:'2d10',extras:`As an action, a Scavenger Fleet can be moved up to three sectors away. Scavenger fleets cost 2 Creds a turn in maintenance.`,text:``},
]
...
let data = {
  assets : ASSETS.map(a=> {
    ...
    a.lv = Number(stat[1])
    //saves
    let saves = a.saves.split(",")
    a.saves = d3.range(saves.length/2).map(i => [SAVENAME[saves[2*i]],Number(saves[2*i+1])])
